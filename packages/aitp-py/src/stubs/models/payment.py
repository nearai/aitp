...
from aitp.stubs.models.payment_payment import PaymentPayment
...
class Payment(BaseModel):
    ...
    payment: PaymentPayment = Field(...)
    __properties = ["$schema", "payment"]
    ...
    def from_dict(cls, obj: dict) -> Payment:
        ...
        _obj = Payment.parse_obj({
            ...
            "payment": PaymentPayment.from_dict(obj.get("payment")) if obj.get("payment") is not None else None
        })
        return _obj
